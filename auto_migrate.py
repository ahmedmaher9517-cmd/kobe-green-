# auto_migrate.py
# Automatic Supabase migration for Al-Ghannam Fabrics ERP
# Runs once on first deployment, creates all tables safely

def migrate_supabase(connection_url):
    """
    Create all ERP tables on Supabase (safe - uses IF NOT EXISTS)
    ...
    try:
        ...
        # Create all tables (translated from SQLite to PostgreSQL)
        SCHEMA = """
        -- Settings
